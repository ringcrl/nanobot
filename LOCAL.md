...
核心代理功能仅需 **约 4,000** 行代码 — 比 Clawdbot 的 430k+ 行代码小 **99%**。

实际代码行数：**3,510 行**（运行 `bash core_agent_lines.sh` 随时验证）

## 📢 最新消息

- **2026-02-10** 🎉 发布 v0.1.3.post6 版本，包含多项改进！查看[更新说明](https://github.com/HKUDS/nanobot/releases/tag/v0.1.3.post6)和[路线图](https://github.com/HKUDS/nanobot/discussions/431)。
- **2026-02-09** 💬 新增 Slack、Email 和 QQ 支持 — nanobot 现已支持多个聊天平台！
- **2026-02-08** 🔧 重构 Provider 机制 — 新增 LLM provider 现在只需简单 2 步！查看[说明](#providers)。
- **2026-02-07** 🚀 发布 v0.1.3.post5 版本，支持 Qwen 及多项关键改进！查看[详情](https://github.com/HKUDS/nanobot/releases/tag/v0.1.3.post5)。
- **2026-02-06** ✨ 新增 Moonshot/Kimi provider、Discord 集成和安全性增强！
- **2026-02-05** ✨ 新增飞书频道、DeepSeek provider 和增强型定时任务支持！
- **2026-02-04** 🚀 发布 v0.1.3.post4 版本，支持多 provider 和 Docker！查看[详情](https://github.com/HKUDS/nanobot/releases/tag/v0.1.3.post4)。
- **2026-02-03** ⚡ 集成 vLLM 支持本地 LLM，改进了自然语言任务调度！
- **2026-02-02** 🎉 nanobot 正式发布！欢迎体验 🐈 nanobot！

## 核心特性

🪶 **超轻量级**：核心代理代码仅约 4,000 行 — 比 Clawdbot 小 99%。
...
> [!TIP]
> `-v ~/.nanobot:/root/.nanobot` 标志将本地配置目录挂载到容器中，因此你的配置和工作区在容器重启后仍然保留。
...
**路线图** — 挑选一个项目并[提交 PR](https://github.com/HKUDS/nanobot/pulls)！
